                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div id="datasetChoose">
                                    ...
                                    <label class="checkbox-inline">
                                        <input type="radio" name="speciesRadio" id="optionsRadios3" value="Animal"
                                               disabled="disabled"> Animal
                                    </label>
                                    <label class="checkbox-inline">
                                        <input type="radio" name="speciesRadio" id="optionsRadios4" value="Plant"
                                               checked> Plant
                                    </label>
                                    <br>
                                    ...
                                    <label class="checkbox-inline">
                                        <input type="radio" name="databaseRadio" value="trnH-psbA" disabled="disabled">
                                        trnH-psbA
                                    </label>
                                    <label class="checkbox-inline">
                            ...
                            <div class="form-group">
                                <div class="btn-group-lg">
                                    <button type="button" id="submitBtn" class="btn btn-default pull-right">Submit and
                                        Search
                                    </button>
